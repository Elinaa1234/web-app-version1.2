...
<body>
	...
	<h1 style="color: red; font-size: 40px;" align="center">WELCOME TO JENKINS CLASS</h1>
        <h1 style="color: yellow; font-size: 40px;" align="center">WE DEPLOYED OUR APP ON 2 SERVERS</h1>
	<h1 style="color: freen; font-size: 40px;" align="center">WELCOME TO Friday CLASS</h1>
